            ...
            <Image
              ...
              src={
                data?.flightDetail?.plane.image
                  ...
                  : "/assets/images/background/airplane.png"
              }
        ...
        <div className="flex flex-col gap-[10px] p-[25px_20px_20px]">
          <div className="flex justify-between text-flysha-black">
            ...
            <span className="font-semibold">
              {data?.flightDetail?.depatureDate
                ? dateFormat(data?.flightDetail?.depatureDate, "DD MMM YYYY")
                : ""}
            </span>
          </div>
          <div className="flex justify-between text-flysha-black">
            ...
            <span className="font-semibold">
              {data?.flightDetail?.depatureDate
                ? dateFormat(data?.flightDetail?.depatureDate, "HH:mm")
                : ""}{" "}
              -{" "}
          ...
          <div className="flex justify-between text-flysha-black">
            <span>Airport</span>
            <span className="font-semibold">
              {data?.flightDetail?.depatureCityCode} -{" "}
