    ...
    <>
      <div className="bg-white flex flex-col rounded-[20px] w-[340px]">
        ...
        <div className="flex flex-col gap-[10px] p-[25px_20px_20px]">
          ...
          <div className="flex justify-between text-flysha-black">
            <span>Time</span>
            <span className="font-semibold">{dateFormat(data.flight.depatureDate, "HH:mm")} - {dateFormat(data.flight.arrivalDate, "HH:mm")}</span>
          </div>
          <div className="flex justify-between text-flysha-black">
            <span>Airport</span>
            <span className="font-semibold">{data.flight.depatureCityCode} - {data.flight.destinationCityCode}</span>
          </div>
          <div className="flex justify-between text-flysha-black">
            <span>Name</span>
